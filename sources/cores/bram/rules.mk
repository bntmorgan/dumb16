...
SIM 			      := $(call SRC_2_BIN, $(d)/bram16.sim)
SRC_SIM_$(d)		:= $(SRC_$(d)) $(d)/rtl/sim_bram16.v $(XILINX_SRC_$(d))
$(SIM)					: $(SRC_SIM_$(d))
$(SIM)					: SIM_CFLAGS := -I$(d)/rtl -I$(CORES_DIR)/sim/rtl/
SIMS						+= $(SIM)

SIM 			      := $(call SRC_2_BIN, $(d)/bram32.sim)
SRC_SIM_$(d)		:= $(SRC_$(d)) $(d)/rtl/sim_bram32.v $(XILINX_SRC_$(d))
$(SIM)					: $(SRC_SIM_$(d))
$(SIM)					: SIM_CFLAGS := -I$(d)/rtl -I$(CORES_DIR)/sim/rtl/
SIMS						+= $(SIM)
